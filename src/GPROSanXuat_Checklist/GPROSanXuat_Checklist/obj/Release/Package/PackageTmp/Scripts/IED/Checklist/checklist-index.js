...
GPRO.Checklist = function () {
                ...
                Code: {
                    ...
                    display: function (data) {
                        ...
                        txt.click(function () {
                            ...
                            $("#checklist-quantities").html(data.record.Quantities);
    ...
    SaveChecklist = () => {
        var obj = {
            ...
            PODetailId: Global.Data.ProductInfo.PODetailId,
            ...
            Quantities: $('#checklist-quantities').html(),
    ...
    bindObj = (id) => {
        ...
        if (found) {
            ...
            $("#checklist-quantities").html(found.Quantities);
