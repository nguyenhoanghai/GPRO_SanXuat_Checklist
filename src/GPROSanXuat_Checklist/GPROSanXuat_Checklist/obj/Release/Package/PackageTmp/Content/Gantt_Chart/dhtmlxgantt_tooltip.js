...
Gantt.plugin(function (t) {
    t._tooltip = {}, t._tooltip_class = "gantt_tooltip", t.config.tooltip_timeout = 30, t.config.tooltip_offset_y = 20, t.config.tooltip_offset_x = 10, t._create_tooltip = function () {
        return this._tooltip_html || (this._tooltip_html = document.createElement("div"), this._tooltip_html.className = t._tooltip_class), this._tooltip_html
    }, t._is_cursor_under_tooltip = function (t, e) { return t.x >= e.pos.x && t.x <= e.pos.x + e.width ? !0 : t.y >= e.pos.y && t.y <= e.pos.y + e.height ? !0 : !1 }, t._show_tooltip = function (e, i) {
        if (!t.config.touch || t.config.touch_tooltip) {
            var n = this._create_tooltip(); n.innerHTML = e,
...
n.style.left = i.x + "px", n.style.top = i.y + "px"
    ...
    t._hide_tooltip = function () {
        ...
        var i = e.target || e.srcElement; return t._is_node_child(i, function (t) {
    ...
    }, t._is_node_child = function (e, i) {
        for (var n = !1; e && !n;) n = i.call(t, e),
e = e.parentNode; return n
    }, t._tooltip_pos = function (e) {
        if (e.pageX || e.pageY)
            var i = { x: e.pageX, y: e.pageY };
        var n = t.env.isIE ? document.documentElement : document.body, i = { x: e.clientX + n.scrollLeft - n.clientLeft, y: e.clientY + n.scrollTop - n.clientTop }, a = t._get_position(t.$task_data); return i.x = i.x - a.x, i.y = i.y - a.y, i
...
clearTimeout(t._tooltip_ev_timer), t._tooltip_ev_timer = setTimeout(function () {
    t._init_tooltip(e, i)
        ...
        if (!this._is_tooltip(e) && (t != this._tooltip_id || this._is_task_line(e))) {
            ...
            this._tooltip_id = t; var i = this.getTask(t), n = this.templates.tooltip_text(i.start_date, i.end_date, i);
            return n ? void this._show_tooltip(n, this._tooltip_pos(e)) : void this._hide_tooltip()
        }
    }, t.attachEvent("onMouseLeave", function (e) {
        t._is_tooltip(e) || this._hide_tooltip();
    }), t.templates.tooltip_date_format = t.date.date_to_str("%d-%m-%Y"), t.templates.tooltip_text = function (e, i, n) {
        var str = "<b>Công Việc:</b> " + n.text;
        str += "<br/><b>Ngày bắt đầu:</b> " + t.templates.tooltip_date_format(e);
        str += "<br/><b>Kết thúc(dự kiến):</b> " + t.templates.tooltip_date_format(n.planned_end)
        str += "<br/><b>Kết thúc(thực tế):</b> " +  t.templates.tooltip_date_format(i);//(n.planned_end == '' ? '' : t.templates.tooltip_date_format(n.planned_end));
        str += "<br/><b>Trạng thái :</b> " + n.status_name + " " + n.progress + '%';
        str += "<br/><b>Người Phụ trách :</b> " + n.employee;
        return str;
    }
});
