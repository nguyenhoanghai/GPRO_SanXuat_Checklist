...
GPRO.namespace('ReportInventory_WH');
GPRO.ReportInventory_WH = function () {
    ...
    var RegisterEvent = function () {
        ...
        $('#inventory_btnExportToExcel').click(function () {
            ...
            window.location.href = `/LotSupplies/ExportToExcel_Inventory?objId=${whId}&groupByMaterial=0`;
        });
    }
    ...
    function GetData() {
        ...
        $.ajax({
            ...
            type: 'POST',
            data: JSON.stringify({ 'objId': whId, 'groupByMaterial': 0 }),
    ...
    GenerateGroupWithWarehouse = (groupObjs) => {
        ...
        if (groupObjs) {
            ...
            $.each(groupObjs, function (i, item) {
                ...
                str += `<tr>
                            <td colspan="5" style=" font-weight: bold; text-align:right; padding-right:20px"> </td>';
...
$(document).ready(function () {
    var obj = new GPRO.ReportInventory_WH();
    obj.Init();
})